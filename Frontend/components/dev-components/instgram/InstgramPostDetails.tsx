...
import { FacebookPost, InstagramPost } from "@/types/fb"
import { PostDetailsTable } from "../facebook/PostDetailsTable"
import { PostContent } from "../facebook/PostContent"
...
import InstagramPostData from "../PostDataIg"

interface InstgramPostDetailsProps {
...
export function InstgramPostDetails({ post, isLoading, error, onClose }: InstgramPostDetailsProps) {
            ...
            <div className="px-6 py-2">
              <Tabs defaultValue="content">
                ...
                <TabsContent value="metrics">
                  ...
                  <InstagramPostData postId={post.postId}/>
                </TabsContent>
              </Tabs>
            </div>
          )}
