...
//                 <tr key={reel.reelId} className="border-b hover:bg-gray-50">
...
//                   </td>
//                   <td className="px-4 py-4 text-sm text-right">{reel.blueReelsPlayCount}</td>
//                   <td className="px-4 py-4 text-sm text-right">{reel.postVideoAvgTimeWatchedSeconds}</td>
//                   <td className="px-4 py-4 text-sm text-right">{reel.postVideoViewTimeSeconds}</td>
//                   <td className="px-4 py-4 text-sm text-right">{reel.postVideoReactions}</td>
//                   <td className="px-4 py-4 text-sm text-right">{reel.postVideoSocialActions}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
