...
import { RefreshCw, PlayCircle, Eye, Clock, Heart, MessageCircle, Share2, TrendingUp, BarChart3 } from "lucide-react"
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      <Card>
        ...
        <CardContent>
          <video src={reel.videoUrl} poster={reel.thumbnailUrl} controls className="w-full rounded-lg shadow-lg" />
            ...
            <TableBody>
              <TableRow>
                <TableCell className="flex items-center">
                  <PlayCircle className="w-4 h-4 mr-2 text-blue-500" /> Play Count
                </TableCell>
                <TableCell className="text-right font-medium">{reel.blueReelsPlayCount.toLocaleString()}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="flex items-center">
                  <Eye className="w-4 h-4 mr-2 text-green-500" /> Unique Impressions
                </TableCell>
                <TableCell className="text-right font-medium">{reel.postImpressionsUnique.toLocaleString()}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="flex items-center">
                  <Clock className="w-4 h-4 mr-2 text-yellow-500" /> Avg. Watch Time
                </TableCell>
              ...
              <TableRow>
                <TableCell className="flex items-center">
                  <TrendingUp className="w-4 h-4 mr-2 text-purple-500" /> Total View Time
                </TableCell>
                <TableCell className="text-right font-medium">
              ...
              <TableRow>
                ...
                <TableCell className="text-right font-medium">{reel.postVideoReactions.toLocaleString()}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="flex items-center">
                  <Share2 className="w-4 h-4 mr-2 text-indigo-500" /> Social Actions
                </TableCell>
                <TableCell className="text-right font-medium">{reel.postVideoSocialActions.toLocaleString()}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="flex items-center">
                  <MessageCircle className="w-4 h-4 mr-2 text-cyan-500" /> Comments
                </TableCell>
                <TableCell className="text-right font-medium">{reel.comments}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="flex items-center">
                  <Clock className="w-4 h-4 mr-2 text-orange-500" /> Length
                </TableCell>
                <TableCell className="text-right font-medium">{reel.length}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="flex items-center">
                  <Eye className="w-4 h-4 mr-2 text-teal-500" /> Reach
                </TableCell>
                <TableCell className="text-right font-medium">{reel.reach}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="flex items-center">
                  <BarChart3 className="w-4 h-4 mr-2 text-pink-500" /> Engagement
                </TableCell>
                <TableCell className="text-right font-medium">{reel.engagement}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </CardContent>
  ...
  return (
    <div className="container p-6 mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold">Facebook Reels Analytics</h1>
                ...
                >
                  <TableCell className="px-6 py-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="max-w-[200px] text-sm text-gray-700 line-clamp-2">{reel.description}</div>
                    </div>
                  </TableCell>
